OC.L10N.register(
    ...
    "This app allows administrators to restrict login to their\nNextcloud server to specific IP ranges. Note that existing sessions will be kept\nopen.\n\nThe allowed IP ranges can be administrated using the OCC command line interface\nor graphical using the admin settings. If you plan to use the OCC tool, the\nfollowing commands would be applicable.\n\nTo whitelist `127.0.0.0/24`:\n\n- `occ config:app:set limit_login_to_ip whitelisted.ranges --value 127.0.0.0/24`\n\nTo whitelist `127.0.0.0/24` and also `192.168.0.0/24`:\n\n- `occ config:app:set limit_login_to_ip whitelisted.ranges --value 127.0.0.0/24,192.168.0.0/24`" : "Esta app permite a los administradores restringir a rangos específicos de IP el acceso a su servidor Nextcloud. Nótese que las sesiones existentes seguirán abiertas.\n\nLos rangos de IP permitidas se pueden configurar usando la interfaz de línea de comandos OCC\n o gráficamente mediante el panel de Configuración. Si usa la herramienta OCC, habría\nque utilizar los siguientes comandos\n\nPara añadir a la lista blanca '127.0.0.0/24':\n\n- 'occ config:app:set limit_login_to_ip whitelisted.ranges --value 127.0.0.0/24'\n\nPara añadir a la lista blanca '127.0.0.0/24' y '192.168.0.0/24':\n\n- 'occ config:app:set limit_login_to_ip whitelisted.ranges --value 127.0.0.0/24,192.168.0.0/24'",
